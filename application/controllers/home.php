	...
	{	
		...
		{      
			...
			if(count($mailSent) > 0){
				...
				$message = "Welcome to <br>Dear ".ucfirst($result->user_fname).' '.ucfirst($result->user_lname).",<p>Nice! Just one more click to complete your registration. </p><a href='".base_url('home/verify?t='.$result->user_token)."'><i>".base_url('home/verify?t='.$result->user_token)."</i></a>";					
